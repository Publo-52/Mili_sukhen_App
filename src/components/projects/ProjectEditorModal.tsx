    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[999999] bg-[#06040a] flex flex-col items-center justify-start sm:justify-center p-3 sm:p-6 pt-12 sm:pt-6 pb-20 sm:pb-6 overflow-y-auto">
        ...
        <motion.div
          ...
          className="relative w-full max-w-2xl bg-[#0e091b] border border-white/20 rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden z-[1000000] my-auto flex flex-col max-h-[85vh] sm:max-h-[88vh]"
        >
          {/* Header */}
