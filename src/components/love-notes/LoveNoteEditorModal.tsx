    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-6 pt-16 sm:pt-8 pb-20 sm:pb-8 overflow-y-auto">
        ...
        <motion.div
          ...
          className="relative w-full max-w-2xl glass-card rounded-2xl sm:rounded-3xl border border-roseGlow-500/30 shadow-2xl overflow-hidden z-[105] my-auto flex flex-col max-h-[82dvh] sm:max-h-[88dvh]"
        >
          {/* Header */}
